    ...
    if menu_selection == "Home Matrix":
        ...
        with col_photo:
            try:
                ...
                st.image("https://i.postimg.cc/yYfV3cDX/Whats-App-Image-2026-06-29-at-4-52-40-PM.jpg", use_container_width=True)
        ...
        with st.expander(" Folder: Local AI Resume Analyzer & Interview Generator", expanded=False):
            ...
            with tab_summary:
                ...
                st.link_button(
                    ...
                    url="https://github.com/nandhinikarunagaran63-sv/data-portfolio/blob/main/dashboard_app.py", # Replace with your real deployed app link later!
                    type="primary"
                )
                st.markdown("---")
